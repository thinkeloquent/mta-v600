 ...
 *
 * Run directly: node rally_health_check.mjs
 *
 * Uses:
...
// Provider API getter
// ============================================================
import { RallyApiToken } from '../../api_token/index.mjs';
...
export async function checkRallyHealth() {
  console.log('='.repeat(60));
  console.log('RALLY HEALTH CHECK');
  console.log('='.repeat(60));
  ...
  const healthEndpoint = '/slm/webservice/v2.0/user';
  console.log('\n[Request]');
...
if (process.argv[1] === __filename) {
  console.log('\n');
  const result = await checkRallyHealth();
  console.log('\n' + '='.repeat(60));
  console.log('RESULT');
  console.log('='.repeat(60));
