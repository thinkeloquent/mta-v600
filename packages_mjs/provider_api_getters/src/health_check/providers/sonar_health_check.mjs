 ...
 *
 * Run directly: node sonar_health_check.mjs
 *
 * Uses:
...
// Provider API getter
// ============================================================
import { SonarApiToken } from '../../api_token/index.mjs';
...
export async function checkSonarHealth() {
  console.log('='.repeat(60));
  console.log('SONAR HEALTH CHECK');
  console.log('='.repeat(60));
  ...
  const healthEndpoint = '/api/authentication/validate';
  console.log('\n[Request]');
...
if (process.argv[1] === __filename) {
  console.log('\n');
  const result = await checkSonarHealth();
  console.log('\n' + '='.repeat(60));
  console.log('RESULT');
  console.log('='.repeat(60));
