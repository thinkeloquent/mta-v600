...
const API_BASE = '/api/hello-fastapi';
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <section className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <textarea
            ...
            rows={3}
            className="w-full border border-gray-300 rounded px-3 py-2 mb-4 font-mono text-sm focus:outline-none focus:ring-2 focus:ring-green-500"
          />
          <button
            onClick={fetchEcho}
            disabled={loading}
        ...
        <section className="bg-white rounded-lg shadow-md p-6">
          ...
          <ul className="space-y-2 font-mono text-sm">
            <li className="flex">
              ...
              <span>/api/hello-fastapi</span>
            </li>
            <li className="flex">
              <span className="bg-blue-100 text-blue-800 px-2 py-1 rounded mr-2">GET</span>
              <span>/api/hello-fastapi/hello?name=World</span>
            </li>
            <li className="flex">
              <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded mr-2">POST</span>
              <span>/api/hello-fastapi/echo</span>
            </li>
            <li className="flex">
              <span className="bg-yellow-100 text-yellow-800 px-2 py-1 rounded mr-2">GET</span>
