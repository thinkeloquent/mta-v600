...
Run directly: python -m provider_api_getters.health_check.providers.sonar_health_check
Or from project root: python packages_py/provider_api_getters/src/provider_api_getters/health_check/providers/sonar_health_check.py
...
if __name__ == "__main__":
    ...
    from provider_api_getters.api_token import SonarApiToken
else:
    # Relative import when used as module
    from ...api_token import SonarApiToken
...
async def check_sonar_health(config: dict = None) -> dict:
    """
...
if __name__ == "__main__":
    ...
    print("\n")
    result = asyncio.run(check_sonar_health(static_config))
    print("\n" + "=" * 60)
    print("RESULT")
    print("=" * 60)
